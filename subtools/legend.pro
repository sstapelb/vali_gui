...
;       "br" : begin & x1=.95 & x0=x1-xsz & y0=.05 & y1=y0+ysz*ystretch & end
      "br" : begin & x0=.55 & x1=x0+xsz & y0=.05 & y1=y0+ysz*ystretch & end
      "tl" : begin & x0=.05 & x1=x0+xsz & y1=.95 & y0=y1-ysz*ystretch & end
;       "tr" : begin & x1=.95 & x0=x1-xsz & y1=.95 & y0=y1-ysz*ystretch & end
      "tr" : begin & x0=.55 & x1=x0+xsz & y1=.95 & y0=y1-ysz*ystretch & end
      "top": begin 
...
; print,'Nachher',x0,x1,y0,y1,sx1,sy1
  endif else begin
...
for i=0,n-1 do begin
  ...
  if titles(i) eq '' then begin
    ...
    xyouts,xlab,ylab,labls(i),color=fgc,charsize=chrsz,/norm,charthick=charthick
    jlbl=jlbl+1
