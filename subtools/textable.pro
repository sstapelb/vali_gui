...
;       $Id: //SAF_CLIM/users/mreuter/idl/tools/textable.pro#1 $
;       $Log: textable.pro,v $
...
;;        TeX SEQUENCE        VECTOR          POSTSCRIPT
    Germans = [$
	[ '"a', 		string(byte(228)),	 string(byte(228))  ],$
	[ '"A', 		string(byte(196)),	 string(byte(196))  ],$
	[ '"u', 		string(byte(252)),	 string(byte(252))  ],$
	[ '"U', 		string(byte(220)),	 string(byte(220))  ],$
	[ '"o', 		string(byte(246)),	 string(byte(246))  ],$
	[ '"O', 		string(byte(214)),	 string(byte(214))  ],$
	[ '\ss', 		string(byte(223)),	 string(byte(223))  ]$
	                  ]
    LowercaseGreek[1,*] = $
    ...
    Germans[1,*] = $
      + PreviousFont[FontSelection] $
      + Germans[FontSelection,*]

    TranslationTable = [[LowercaseGreek],[UppercaseGreek],[Symbols],[Germans]]
